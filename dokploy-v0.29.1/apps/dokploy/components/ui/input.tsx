			...
			<>
				<div className="relative w-full">
					<input
						...
						className={cn(
							// bg-gray
							"flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-ring focus-visible:shadow-[0_0_0_3px_hsl(var(--ring)/0.18)] read-only:bg-muted disabled:cursor-not-allowed disabled:opacity-50",
