		...
		<div className="w-full">
			<Card className="h-full bg-sidebar rounded-lg">
				<div className="rounded-xl bg-background shadow-md p-6">
					...
					<CardContent className="space-y-6 pt-6 border-t px-0 pb-0 flex flex-col min-h-[60vh]">
						{isPending ? (
									...
									<div className="flex items-center gap-2">
										...
										<div className="flex items-center gap-2 min-w-48 max-sm:w-full">
											...
											<Select value={sortBy} onValueChange={setSortBy}>
												...
												<SelectContent>
													<SelectItem value="name-asc">이름 (ㄱ-ㅎ)</SelectItem>
																	...
																	{hasNoEnvironments && (
																		<div className="flex flex-row gap-2 items-center rounded-lg bg-yellow-50 p-2 mt-2 dark:bg-yellow-950">
																			...
																			<span className="text-xs text-yellow-600 dark:text-yellow-400">
																				프로젝트에 접근할 수 있지만 사용 가능한 환경이 없습니다
																			</span>
																		</div>
																	)}
																</span>
